                ...
                >
                    <div class="max-w-4xl mx-auto w-full space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <button
                                id="retry-button"
                                class="px-4 py-2 rounded-xl border border-slate-300 dark:border-slate-600 text-sm text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                            >
                                Retry
                            </button>
                            <button
