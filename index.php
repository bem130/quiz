        ...
        <aside class="side-panel app-surface-side border-l app-border-subtle text-xs transition-colors duration-300">
            ...
            <section id="side-editor" class="hidden flex-1 min-h-0 flex flex-col">
                ...
                <div class="flex items-center gap-2 px-4 py-2 border-b app-border-subtle">
                    ...
                    <div class="ml-auto">
                        <button id="draft-preview-scroll-json"
                            class="hidden px-2 py-1 text-[11px] font-semibold rounded border app-border-subtle app-text-main hover:app-surface-overlay"
