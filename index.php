        ...
        <main class="main-panel bg-white dark:bg-slate-850 flex flex-col transition-colors duration-300">
            ...
            <section id="main-menu" class="flex-1 overflow-y-auto p-6 space-y-6 text-sm">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-2">
                    ...
                    <button
                        id="start-button"
                        class="interactive-button px-5 py-2 text-sm font-semibold rounded-xl
                ...
                >
                    <div class="max-w-4xl mx-auto w-full space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <button
                                id="retry-button"
                                class="interactive-button px-4 py-2 rounded-xl border border-slate-300 dark:border-slate-600 text-sm text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                            >
                                Retry
                            </button>
                            <button
                            ...
                            <button
                                ...
                                class="interactive-button px-4 py-2 rounded-xl text-sm font-semibold border border-slate-300 dark:border-slate-600 bg-white text-slate-800 hover:bg-slate-100 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-700 transition-colors"
                            >
                                Copy Result
                            </button>
                            <button
                                id="back-to-menu-button"
                                class="interactive-button px-4 py-2 rounded-xl text-sm
                        ...
                        >
                            ...
                            <div class="pt-2">
                                <button
                                    ...
                                    type="button"
                                    class="interactive-button inline-flex items-center px-3 py-1.5 rounded-lg border border-slate-500/80 text-[11px] font-semibold bg-slate-800/80 hover:bg-slate-700/80 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    Install this app
                                </button>
                            </div>
                ...
                <div class="px-3 py-2 flex items-center justify-between gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button
                            ...
                            type="button"
                            class="interactive-button px-3 py-1 rounded-full border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-[0.8rem] text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                        >
                            Dark / Light
                        </button>
                    </div>
                    ...
                    <button
                        ...
                        type="button"
                        class="interactive-button px-3 py-1 rounded-full border border-slate-300 dark:border-slate-600
                    ...
                    <section class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <button
                                id="entry-add-button"
                                type="button"
                                class="interactive-button px-3 py-2 rounded-xl text-xs font-semibold border border-slate-300 dark:border-slate-600 bg-white text-slate-800 hover:bg-slate-100 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-700 transition-colors"
                            >
                                Add
                            </button>
                            </div>
