...
export const dom = {
    ...
    queueLearningCount: document.getElementById('queue-learning-count'),
    queueRelearningCount: document.getElementById('queue-relearning-count'),
    queueReviewCount: document.getElementById('queue-review-count'),
